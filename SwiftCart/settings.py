...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,swift-cart-alx-project-nexus.onrender.com', cast=Csv())
...
LOGGING = {
    ...
    'handlers': {
        ...
        'error_file': {
            'class': 'logging.FileHandler',
            'filename': os.path.join(LOG_DIR, 'swiftcart_errors.log'),
            'formatter': 'verbose',
            'level': 'ERROR',
            'encoding': 'utf-8',
        },
